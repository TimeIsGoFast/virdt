...
<title>旅行管理</title>
   ...
   <link href='https://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    ...
    <link href="${pageContext.request.contextPath}/static/assets/js/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
		  ...
		  <div class="header"> 
              <h1 class="page-header">
                  <a href="${pageContext.request.contextPath }/travel/addTravel.do" class="btn btn-info">添加旅行地点</a>
              </h1>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                         <c:forEach items="${list}" var="travel">
                                            ...
                                            <td>${travel.city }</td>
                                            <td class="center">${travel.airport }</td>
                                            <td>${travel.price }</td>
                                            <td class="center">${travel.grade }</td>
                                            <td align="center">
                                            <button class="btn btn-primary" title='详情'  data-toggle="modal" data-target="#myModal"><i class="fa fa-book "></i></button>
                                            <button class="btn btn-danger" title='删除' onclick="_deleteBook('${travel.id}')"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                            </td>
                                        </tr>
                                         </c:forEach>
                                    </tbody>
    ...
    <script src="${pageContext.request.contextPath}/static/js/travel.js"></script>
